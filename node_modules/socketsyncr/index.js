	...
	this.register = function(syncable,client) {
		...
		syncable.on('change', function() {
			self.message_all_except(
				shared.build_syncable_event_message(syncable_changed_,syncable), client.sessionId
			)
		})
		
		if (client) {
			self.message_all_except(
				shared.build_syncable_event_message(new_syncable_,syncable), client.sessionId
			);
			self.message(
				shared.build_syncable_event_message(server_set_id_,null,self.sync_id_next), client.sessionId
			)
